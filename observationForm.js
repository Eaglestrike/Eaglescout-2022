		...
		if (category == "competition") {
			...
			if (structure[category].input == "dropdown") {
				...
				if (structure[category].title.contains("Low")) {
					...
					// plus button
					finalString += '<a class="btn increment_number_plus_button col s2" data-for="' + category + '"><img src="https://github.com/Eaglestrike/Eaglescout-2022/blob/button-change/images/lower_plus.png?raw=true"></a>';
				} else {
					// minus button
